        ...
        <section ref={ref} id="transition" className={(shouldShow ? 'visible' : 'notvisible') + ' navbar'}>
            <Fade delay={2000}>
                <ul className="details">
                    ...
                    <li><a target="_blank" className="nav" href="https://www.github.com/babakhadady">GITHUB</a></li>
                    <li><a target="_blank" className="nav" href = "mailto: hadadybabak@gmail.com">CONTACT</a></li>
