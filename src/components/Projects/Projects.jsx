			...
			<div ref={ref} className={"project-container "} data-aos="fade">
				<a className="text-header" href="http://www.github.com/babakhadady/playify">
					<div className={"text-container "}>
						...
						<div className={"text-body "}>Designed a responsive frontend in React.js with React BootStrap allowing for submission of artists by a user.
						</div>
						<div className={"text-body"}>Utilizes OAUTH 2.0 protocol alongside RESTFul Spotify API to allow users to securely connect their Spotify accounts to Playify.
						</div>
						<div className={"text-body"}>Constructed a secure backend built on Node.js with Express that retrieves submitted artists songs through GET requests.
						</div>
						<div className={"text-body"}>Dynamically named playlist allows connected users to customize their generated playlist, visible through PUT requests.
						</div>
						<div className="text-tech">Built With
			...
			<div ref={ref} className={"project-container larger"} data-aos="fade">
				<a className="text-header" href="https://courses.students.ubc.ca/cs/courseschedule?pname=subjarea&tname=subj-course&dept=CPSC&course=310">
					<div className={"text-container "}>
						...
						<div className={"text-header2 "}>UBC Course Database Application</div>
						<div className={"text-body "}>Fullstack application allowing users to query databases containing UBC course information built on TypeScript and Node.</div>
						<div className={"text-body"}>Designed and Implemented a robust frontend built on React with Bootstrap </div>
						...
						<div className="text-body">Utilized the Agile/Scrum process for efficient project delivery and to meet deadlines.</div>
